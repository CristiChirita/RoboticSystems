# -*- coding: utf-8 -*-
	...
	# Basically the forward search class, but implements its own algorithm

from best_search_algorithm import BestSearchAlgorithm
from collections import deque
from cell import *

class CellBasedBestSearch(BestSearchAlgorithm):

    # Self implements a simple FIFO search algorithm
    
    def __init__(self, title, occupancyGrid):
        BestSearchAlgorithm.__init__(self, title, occupancyGrid)
